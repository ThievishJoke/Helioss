...
data:extend({
  ...
  },
  {
    ...
    type = "noise-expression",
    name = "helioss_mountains_elevation_multiplier",
    expression = 1.5
  },
  ...
  ---- New checks to prevent lava near water
  {
      type = "noise-expression",
      name = "vulcanus_lava_elevation_check",
      expression = "max(helioss_elevation, 0) * (1 - vulcanus_biome_water_proximity)"
  },
  
  {
      type = "noise-expression",
      name = "vulcanus_temperature_check",
      expression = "helioss_temperature * (1 - vulcanus_biome_water_proximity)"
  },
  
  {
      type = "noise-expression",
      name = "vulcanus_moisture_check",
      expression = "helioss_moisture * (1 - vulcanus_biome_water_proximity)"
  },
  
  {
      type = "noise-expression",
      name = "final_lava_spots",
      expression = "max(vulcanus_lava_elevation_check, 0.5) * vulcanus_temperature_check * vulcanus_moisture_check"
  },
  ---- Starting Area blobs
  {
    type = "noise-expression",
  ...
  {
    type = "noise-expression",
    name = "vulcanus_biome_water_proximity",
    expression = "clamp(1 - distance_to_water / 20, 0, 1)",
    local_expressions = {
      distance_to_water = "spot_noise{x = x, y = y, seed0 = map_seed, seed1 = 5678, region_size = 64, density_expression = 1, spot_radius_expression = 10, spot_quantity_expression = 1, spot_favorability_expression = 1, basement_value = 0, maximum_spot_basement_radius = 10}"
    }
  },
  {
    type = "noise-expression",
    name = "final_lava_spots",
    expression = "max(mountain_lava_spots * (1 - vulcanus_biome_water_proximity), 0)"
  },
  {
    type = "noise-expression",
    name = "vulcanus_basalts_biome_adjusted",
    expression = "vulcanus_basalts_biome * (1 - mountain_lava_spots)"
  },
  {
    type = "noise-function",
  ...
  },
  {
      type = "noise-expression",
      name = "vulcanus_flood_cracks_a",
      expression = "lerp(min(vulcanus_plasma(7543, 2 * vulcanus_cracks_scale, 3.5 * vulcanus_cracks_scale, 0.4, 0.8),\z
                             vulcanus_plasma(7443, 1.2 * vulcanus_cracks_scale, 2.5 * vulcanus_cracks_scale, 0.3, 0.7)),\z
                         1,\z
  ...
  },
  {
      ...
      name = "vulcanus_flood_cracks_b",
      expression = "lerp(1,\z
                         min(vulcanus_plasma(12223, 1.8 * vulcanus_cracks_scale, 2.5 * vulcanus_cracks_scale, 0.3, 0.6),\z
                             vulcanus_plasma(152, 0.9 * vulcanus_cracks_scale, 1.3 * vulcanus_cracks_scale, 0.2, 0.5)) - 0.4,\z
                         clamp(0.1 + vulcanus_detail_noise(821, 4 * vulcanus_cracks_scale, 2, 0.3), 0, 1))"
  },
  {
      type = "noise-expression",
      name = "vulcanus_flood_paths",
      -- Define paths or channels that can be filled with water.
      expression = "0.2\z
                    - vulcanus_plasma(1543, 1 * vulcanus_cracks_scale, 2.5 * vulcanus_cracks_scale, 0.4, 0.8)\z
                    + min(0, vulcanus_detail_noise(121, vulcanus_cracks_scale * 3, 2, 0.4))"
  },
  {
    type = "noise-expression",
    name = "vulcanus_flood_basalts_func",
    -- Generate depressions for water, completely removing lava outputs
    expression = "min(max(vulcanus_flood_cracks_a - 0.125, vulcanus_flood_paths), vulcanus_flood_cracks_b)\z
                  + 0.3 * min(0.5, vulcanus_hairline_cracks)\z
                  + clamp(vulcanus_cracks_scale - 0.3, 0, 1) * -1" -- Push lava-producing ranges below threshold
  },
  {
    type = "noise-expression",
    name = "vulcanus_water_fill",
    -- Replace depressions with water
    expression = "clamp(-vulcanus_flood_basalts_func, 0, 1) * 0.5" -- Generates water bodies without lava
  },
  {
    type = "noise-expression",
    name = "vulcanus_volcanic_pockets",
    -- Isolated volcanic patches without affecting water
    expression = "clamp(vulcanus_plasma(2341, 3, 6, 0.5, 1) - 0.6, 0, 1) * 0.8"
  },
  {
    type = "noise-expression",
    name = "helioss_elevation_offset",
    expression = "0"
  },
  {
    type = "noise-function",
  ...
  },
  {
    type = "noise-expression",
    name = "vulcanus_elev",
    expression = "helioss_elevation_offset\z
                  + lerp(lerp(120 * vulcanus_basalt_lakes_multisample,\z
                              20 + vulcanus_mountains_func * helioss_mountains_elevation_multiplier,\z
